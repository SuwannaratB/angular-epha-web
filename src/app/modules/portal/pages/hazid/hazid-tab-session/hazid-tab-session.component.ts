...
@Component({
  selector: 'app-hazid-tab-session',
  templateUrl: './hazid-tab-session.component.html',
  styleUrl: './hazid-tab-session.component.scss'
})
export class HazidTabSessionComponent {
